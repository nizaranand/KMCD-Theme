...
class wpe_knowledge_meta_box {
	...
	function show() {
		...
		wp_nonce_field(basename(__FILE__), 'wpe_knowledge_meta_box_nonce');
	...
	function save($post_id) {
		...
		|| (!check_admin_referer(basename(__FILE__), 'wpe_knowledge_meta_box_nonce'))		// verify nonce
		...
		foreach ($this->_fields as $field) {
			...
			// validate meta value
			if (class_exists('wpe_knowledge_meta_box_Validate') && method_exists('wpe_knowledge_meta_box_Validate', $field['validate_func'])) {
				$new = call_user_func(array('wpe_knowledge_meta_box_Validate', $field['validate_func']), $new);
			}
